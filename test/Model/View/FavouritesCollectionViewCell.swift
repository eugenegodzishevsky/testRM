...
class FavouritesCollectionViewCell: UICollectionViewCell {
    static let cellIdentifier = "FavouriteEpisodeCell"
    ...
    @objc func heartImageViewTapped() {
        ...
        if isFavourite {
            print("favouriteeeeee")
            let defaultEpisode = RMEpisode.init(id: 000, name: "", air_date: "", episode: "", characters: [], url: "", created: "")
            FavouritesManager.shared.favouriteEpisodes.append(episode ?? defaultEpisode)
        } else {
            print("Nooooooot favouriteeeeee")
...
extension UIImageView {
    func setFavImage(from url: String) {
